...
<div class="contact<?php echo $this->pageclass_sfx?> row" itemscope itemtype="https://schema.org/Person">
	...
	<?php if ($this->contact->image && $tparams->get('show_image')) : ?>
		<div class="thumbnail col-xs-12 col-md-5 clearfix">
	...
	<?php if ($this->contact->con_position && $tparams->get('show_position')) : ?>
		<dl class="contact-position dl-horizontal col-xs-12 col-md-7 clearfix">
			<dt>
	...
	<?php if ($tparams->get('show_email_form') && ($this->contact->email_to || $this->contact->user_id)) : ?>
		...
		<?php elseif ($presentation_style == 'plain') : ?>
			<?php echo '<h3 class="clearfix">' . JText::_('COM_CONTACT_EMAIL_FORM') . '</h3>'; ?>
		<?php endif; ?>
