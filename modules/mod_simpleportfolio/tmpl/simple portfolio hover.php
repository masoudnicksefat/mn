...
#mm-simpleportfolio .modal-item {
	position:relative;
	
}
#mm-simpleportfolio .text-info {
  visibility:hidden;
  color: #FAFAFA;
  height: 100%;
  position: absolute;
...
#mm-simpleportfolio .modal-item:hover .text-info {
...
<div class="modal-feature col-xs-12 col-sm-6 col-md-4 col-lg-2 clearfix" data-toggle="modal" data-target="#myModal<?php echo '_'.$id; ?>">
	<div class="modal-item clearfix">
        ...
        <div class="text-info">
            ...
            <?php echo $introtext; ?>
            <a class="btn btn-info" role="button">مشاهده جزئیات پروژه</a>
        </div>
    </div>
</div>
